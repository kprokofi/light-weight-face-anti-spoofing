...
data = dict(cuda=True, batch_size=100, data_loader_workers=2, sampler = True, pin_memory=True, data_root='/home/prokofiev/pytorch/antispoofing/CelebA_Spoof')

resize = dict(height=128, width=128)

checkpoint = dict(snapshot_name="MobileNet3_test.pth.tar", 
                  experiment_path='/home/prokofiev/pytorch/antispoofing/log_tensorboard/MobileNet_Celeba_test')

loss = dict(loss_type='amsoftmax', 
            amsoftmax=dict(m=0.5, s=5, margin_type='cos', label_smooth=False, smoothing=0.1),
